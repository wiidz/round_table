...
🚧 **架构设计阶段** — 当前以领域建模与 ADR 为主，尚无可运行代码。

实现顺序见 [CONSTITUTION.md](./docs/CONSTITUTION.md) § Implementation Order：

Vision → Core Concepts → Domain Model → Moderator Scheduler → Meeting Engine → Adapters → UI
