...
var (
	...
	errSetupInvalidParticipants = errors.New("discord: invalid participant selection")
	...
	errExpertRefRequired   = errors.New("discord: expert id or display name required")
	errExpertEditEmpty     = errors.New("discord: edit fields required")
	errExpertEditInvalid   = errors.New("discord: invalid edit field")
)
