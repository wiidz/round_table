...
最后更新：2026-06-29（WebChat IM 基线 + 圆桌 Live ADR）
...
| 项 | 说明 | 状态 |
|----|------|------|
| WebChat Transport | WS `/api/chat/ws`，无需 Principal，可发起/进行会议 | ✅ `3561e2e` |
| WebChat IM 基线 | 线性聊天窗、头像、尖角气泡、时间戳 | ✅ `3561e2e` |
...
| REST/WS | 与 Engine 同源，Transport 可切换 | 部分（Chat WS） |
